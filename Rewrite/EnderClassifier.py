...
class EnderClassifier(BaseEstimator, ClassifierMixin):
    def __init__(self, dataset_name: str = None, n_rules: int = 100, use_gradient: bool = True, optimized_searching_for_cut: bool = False, nu: float = 1,
        ...
        self.use_gradient: bool = use_gradient # Whether to use gradient descent or the newton raphson step
        self.nu: float = nu # Shrinkage parameter (like learning rate)
        self.sampling: float = sampling # Sampling rate for training instances
